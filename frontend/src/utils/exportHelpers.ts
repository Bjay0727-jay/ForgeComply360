...
<body>
  ...
  <p class="meta">Generated on ${escapeHtml(now)} by Forge Cyber Defense</p>
  ${content}
</body>
</html>`.trim();
...
export async function exportSSPPackageDoc(
  ...
  <div style="text-align:center; padding-top:120pt; padding-bottom:120pt;">
    ...
    <p style="font-size:9pt; color:#aaa; margin-top:36pt;">Generated by Forge Cyber Defense</p>
  </div>
...
export async function exportComplianceDoc(
  ...
  <div style="text-align:center; padding-top:100pt; padding-bottom:100pt;">
    ...
    <p style="font-size:9pt; color:#aaa; margin-top:32pt;">Generated by Forge Cyber Defense</p>
  </div>
  <div class="page-break"></div>
  `;
...
export async function exportRiskRegisterDoc(risks: any[], orgName: string): Promise<void> {
  ...
  html += '</table>';
  html += '<p style="font-size:8pt;color:#a0aec0;margin-top:40px;text-align:center;">Generated by Forge Cyber Defense &mdash; RiskForge ERM</p>';
...
export async function exportVendorAssessmentDoc(vendor: any, orgName: string): Promise<void> {
  ...
  html += '<p style="font-size:8pt;color:#a0aec0;margin-top:40px;text-align:center;">Generated by Forge Cyber Defense &mdash; VendorGuard TPRM</p>';
...
export async function exportExecutiveSummaryReport(data: ReportData, orgName: string): Promise<void> {
  ...
  html += `<p style="font-size:8pt;color:#a0aec0;margin-top:40pt;text-align:center;">Generated by Forge Cyber Defense &mdash; Reporting &amp; Export Engine</p>`;
...
<div style="margin-top:48pt; padding-top:12pt; border-top:1px solid #ccc; font-size:8pt; color:#999;">
  <table style="width:100%; border:none;">
    <tr style="border:none; background:none;">
      <td style="border:none; padding:2pt;">Generated by Forge Cyber Defense</td>
