...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'evidence', path: '/evidence', icon: 'M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z', label: 'Artifact Repository' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'analytics', path: '/analytics', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', label: 'Analytics', minRole: 'analyst' },
    ],
  },
  {
    key: 'riskMonitoring',
    ...
    items: [
      ...
      { key: 'security-incidents', path: '/security-incidents', icon: 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z', label: 'Incidents', minRole: 'admin' },
    ],
  },
  {
    key: 'tools',
    ...
    items: [
      { key: 'aiWriter', path: '/ai-writer', icon: 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z', label: 'Authorization Packages' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'servicenow', path: '/servicenow', icon: 'M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4', label: 'ServiceNow CMDB', minRole: 'manager' },
          ...
          <div className="shrink-0 p-3 border-t border-white/10">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-2 py-1.5 rounded-lg text-xs text-white/60 hover:text-white/90 hover:bg-white/10 transition-colors"
              ...
              <button
                onClick={logout}
                className={`flex-1 flex items-center justify-center gap-2 px-2 py-1.5 rounded-lg text-xs text-white/70 ${brandHover} hover:text-white`}
              >
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
