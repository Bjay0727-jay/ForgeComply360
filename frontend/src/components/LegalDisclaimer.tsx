  ...
  const disclaimerContent = (
    <>
      ...
      <section className="mb-4">
        ...
        <p className={TYPOGRAPHY.body}>
          Use of Forge Cyber Defense does not guarantee compliance with any federal, state, or industry
      ...
      <section className="mb-4">
        ...
        <p className={TYPOGRAPHY.body}>
          ...
          operators, or licensors of Forge Cyber Defense be liable for any indirect, incidental,
    ...
    return (
      <div className="text-center py-4 border-t border-gray-200 dark:border-gray-700">
        <p className={TYPOGRAPHY.bodySmallMuted}>
          Forge Cyber Defense is a compliance management tool and does not provide legal advice.
